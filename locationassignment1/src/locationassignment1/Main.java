...
class Dynamic_programming {
    ...
    double calculate_value(String nc, String sc, String[] gn, String[] nc_pre, String[] sc_pre, double[] va_pre, double[] ratio){
        ...
        while(n<s*t){
            ...
            for(int i=0; i<nc.length; i++){
                ...
                for(int j=0; j<sc.length; j++){
                   nc_cur[index] = nc[i];
                   sc_cur[index] = sc[j];
                   va_cur[index] = calculate_value(nc[i], sc[j], gn, nc_pre, sc_pre, va_pre, ratio);
                   if(n==s*t)
    ...
    void dynamic_programming(int s, int t, String[] gn, double[] ratio, int compare){
        // s: the number of stacks
        // t: the number of tiers
        // g: the number of weight groups
        int n=0;
                ...
                for(int i=0; i<nc.length; i++){
                    ...
                    for(int j=0; j<sc.length; j++){
                       ...
                       for(int k=0; k<gn.length; k++)
                           write.print(next_weight_group[k]+"\t"+next_state[k][0]+"\t"+next_state[k][1]+"\t"+next_value[k]+"\t");
                       write.println();
                       if(n==s*t)
                        final_value =va_cur[index];
                       index++;
...
class Calculate_total_rehandle_prepare{
    ...
    void datainput(String filename, String[] gn){
       ...
       for(int i=0; i<dataarray.length; i++){
           ...
           for(int k=0; k<gn.length; k++){
              next_weight_group[i][k] =  dataarray[i][4*k+3];
              next_state[i][2*k+0] = dataarray[i][4*k+4];
              next_state[i][2*k+1] = dataarray[i][4*k+5];
              next_value[i][k] = Double.valueOf(dataarray[i][4*k+6]);
           }
       }
    }
																...
																for(int k4=0; k4<gn.length; k4++)
																	for(int k5=0; k5<gn.length; k5++)
																					...
																					for(int k9=0; k9<gn.length; k9++){
                                                                                                            							permutation[index] = gn[i]+gn[i1]+gn[i2]+gn[i3]+gn[i4]+gn[i5]+gn[i6]+gn[i7]+gn[i8]+gn[i9]+gn[j]+gn[j1]+gn[j2]+gn[j3]+gn[j4]+gn[j5]+gn[j6]+gn[j7]+gn[j8]+gn[j9]+gn[k]+gn[k1]+gn[k2]+gn[k3]+gn[k4]+gn[k5]+gn[k6]+gn[k7]+gn[k8]+gn[k9];
                                                                                            ...
                                                                                            for(int k=0; k<gn.length; k++)
                                                                                                for(int k1=0; k1<gn.length; k1++)
                                                                                                    for(int k2=0; k2<gn.length; k2++)
                                                                                                        for(int k3=0; k3<gn.length; k3++)
																for(int k4=0; k4<gn.length; k4++){
                                                                                                            permutation[index] = gn[i]+gn[i1]+gn[i2]+gn[i3]+gn[i4]+gn[i5]+gn[i6]+gn[i7]+gn[i8]+gn[i9]+gn[j]+gn[j1]+gn[j2]+gn[j3]+gn[j4]+gn[j5]+gn[j6]+gn[j7]+gn[j8]+gn[j9]+gn[k]+gn[k1]+gn[k2]+gn[k3]+gn[k4];
                                                                                                            index++;
                                                                                                        }
...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       // Vector values = new Vector();
        ...
        //[] ratio ={0.5,0.5};
        //String[] gn = {"H","L"};
        //double[] ratio ={0.25,0.25,0.25,0.25};
        //String[] gn = {"H","M","L","V"};
        ...
        try{
            ...
            for(int s=4; s<5; s++)
                for(int t=3; t<5; t++)
                    ...
                    write.println(s+"\t"+t+"\t"+3+"\t"+dynamic_programming.state_size+"\t"+dynamic_programming.final_value+"\t"+duration);
...
/*
        ...
        for(int s=2; s<5; s++)
                for(int t=2; t<7; t++)
                    if(s*t<=4){
        calculate_total_rehandle.calculate_total_rehandle(s, t, gn);
                    }
*/
